function fig=hom_gui_H(i1,i2,H)
%
%	fig=hom_gui_H(i1,i2,H)
%
%
...
% $Id: hom_gui_H.m,v 1.3 2001/10/30 14:42:41 wexler Exp $
...
if strcmp(action, 'start'),
	...
	h0 = figure('Color',[0.8 0.8 0.8], ...
		...
		'WindowButtonUpFcn', 'hom_gui_H(''none'');',...
		'WindowButtonMotionFcn', 'hom_gui_H(''move'')', ...
		'Pointer', 'crosshair', ...
		'DoubleBuffer', 'on',...
		'Units','normalized');
	m0=uimenu('Label', '&Color');
	uimenu(m0, 'Label', '&Red', 'ForegroundColor', [1, 0, 0], ...
		'Accelerator', 'r', 'Callback', 'hom_gui_H(''cr'');');
	uimenu(m0, 'Label', '&Green', 'ForegroundColor', [0, 1, 0], ...
		'Accelerator', 'g', 'Callback', 'hom_gui_H(''cg'');');
	uimenu(m0, 'Label', '&Blue', 'ForegroundColor', [0, 0, 1], ...
		'Accelerator', 'b', 'Callback', 'hom_gui_H(''cb'');');
	m1=uimenu('Label', '&Size');
	uimenu(m1, 'Label', '&Increase', 'Callback', 'hom_gui_H(''s+'');', 'Accelerator', '+');
	uimenu(m1, 'Label', '&Decrease', 'Callback', 'hom_gui_H(''s-'');', 'Accelerator', '-');
	uimenu(m1, 'Label', '&1', 'Callback', 'hom_gui_H(''s1'');', 'Accelerator', '1');
	uimenu(m1, 'Label', '&2', 'Callback', 'hom_gui_H(''s2'');', 'Accelerator', '2');
	uimenu(m1, 'Label', '&3', 'Callback', 'hom_gui_H(''s3'');', 'Accelerator', '3');
	uimenu(m1, 'Label', '&4', 'Callback', 'hom_gui_H(''s4'');', 'Accelerator', '4');
	uimenu(m1, 'Label', '&5', 'Callback', 'hom_gui_H(''s5'');', 'Accelerator', '5');
	uimenu(m1, 'Label', '&6', 'Callback', 'hom_gui_H(''s6'');', 'Accelerator', '6');
	uimenu(m1, 'Label', '&7', 'Callback', 'hom_gui_H(''s7'');', 'Accelerator', '7');
	uimenu(m1, 'Label', '&8', 'Callback', 'hom_gui_H(''s8'');', 'Accelerator', '8');
	uimenu(m1, 'Label', '&9', 'Callback', 'hom_gui_H(''s9'');', 'Accelerator', '9');
	...
	hold on;
	title('Image 1');
	set(h1, 'ButtonDownFcn', 'hom_gui_H(''b1'');');
	...
	hold on;
	title('Image 2');
	set(h2, 'ButtonDownFcn', 'hom_gui_H(''b2'');');
